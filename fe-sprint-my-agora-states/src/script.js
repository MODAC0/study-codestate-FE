...
// serverDiscussions 배열의 모든 데이터를 화면에 렌더링하는 함수입니다.
...
form.addEventListener("submit", (event) => {
  ...
  // data.js의 serverDiscussions 배열 안으로 submit된 obj 변수를 추가한다
  // unshift를 사용해서 맨 앞으로 보낸다(최신순)
  serverDiscussions.unshift(submitObj);
  // data.js의 serverDiscussions.obj를 convertToDiscussion 함수에 넣어 li 안의 자식 태그들로 변환시켜 li 더미를 반환시킨다.
...
// ul 요소에 serverDiscussions 배열의 모든 데이터를 화면에 렌더링합니다.
const ul = document.querySelector("ul.discussions__container");
